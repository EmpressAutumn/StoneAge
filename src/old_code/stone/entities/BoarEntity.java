        ...
        if (Math.min(dataManager.get(WildAnimalEntity.GENERATION), ageable.getDataManager().get(WildAnimalEntity.GENERATION)) >= Config.domesticateAfterGenerations) {
            ...
            if (child != null) {
                ...
                if (result instanceof AgeableEntity) {
                    ...
                    LivingEntity.LOGGER.warn("'{}' is not instance of Ageable entity! Spawning default PIG entity", Config.boarBreedingResult);
                }
            } else {
                LivingEntity.LOGGER.warn("'{}' does not exists! Spawning default PIG entity", Config.boarBreedingResult);
            }
