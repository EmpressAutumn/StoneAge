        ...
        if (Math.min(dataManager.get(WildAnimalEntity.GENERATION), ageable.getDataManager().get(WildAnimalEntity.GENERATION)) >= Config.domesticateAfterGenerations) {
            ...
            if (child != null) {
                ...
                if (result instanceof AgeableEntity) {
                    ...
                    LivingEntity.LOGGER.warn("'{}' is not instance of Ageable entity! Spawning default CHICKEN entity", Config.fowlBreedingResult);
                }
            } else {
                LivingEntity.LOGGER.warn("'{}' does not exists! Spawning default CHICKEN entity", Config.fowlBreedingResult);
            }
