...
public class ContainerSubscriber {
    ...
    public static void registerContainer(@Nonnull RegistryEvent.Register<ContainerType<?>> event) {
        ...
        registry.register(stone_chest.setRegistryName(Reference.MODID, "stone_chest"));
        registry.register(feeder.setRegistryName(Reference.MODID, "feeder"));
        registry.register(millstone.setRegistryName(Reference.MODID, "millstone"));
        registry.register(backpack.setRegistryName(Reference.MODID, "backpack"));
        registry.register(stone_tablet.setRegistryName(Reference.MODID, "stone_tablet"));
        registry.register(fishing_net.setRegistryName(Reference.MODID, "fishing_net"));
    }
}