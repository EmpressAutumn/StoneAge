...
public class ForgeEventSubscriber {
    private static final String PLAYER_MANUAL_NBT = Reference.MODID + "_manual";
    ...
    private static final Set<ResourceLocation> RECIPES_TO_ADD = Sets.newHashSet(
            new ResourceLocation(Reference.MODID, "crafting_table")
    );
    ...
    public static void rightClickBlockEvent(@Nonnull PlayerInteractEvent.RightClickBlock event) {
        ...
        if (Config.disableVanillaCraftingTable && (blockState.getBlock() == Blocks.CRAFTING_TABLE) && (AgeUtils.getPlayerAge(event.getPlayer()) <= Age.STONE_AGE.value)) {
    ...
    public static void advancementEvent(@Nonnull AdvancementEvent event) {
        if (event.getAdvancement().getId().equals(new ResourceLocation(Reference.MODID, "stone_age/end_of_stone_age")) && (AgeUtils.getPlayerAge(event.getPlayer()) <= Age.STONE_AGE.value)) {
    ...
    public static void litTorch(@Nonnull PlayerInteractEvent.RightClickBlock event) {
        ...
        if (event.getHand() == Hand.MAIN_HAND && player.getHeldItemMainhand().getItem().equals(ItemSubscriber.unlit_torch)) {
            ...
            if (blockState.getBlock().equals(Blocks.CAMPFIRE) || faceBlockState.getBlock().equals(Blocks.FIRE) || blockState.getBlock().equals(Blocks.TORCH)) {
    ...
    public static void serverAboutToStartEvent(@Nonnull FMLServerAboutToStartEvent event) {
        for (Biome biome : ForgeRegistries.BIOMES) {
            ...
            if (Config.removeVanillaGeneratedAnimals) {
                ...
                biome.getSpawns(CREATURE).removeIf(entry -> Sets.newHashSet(EntityType.COW, EntityType.SHEEP, EntityType.PIG, EntityType.CHICKEN).contains(entry.entityType));
            }
