...
public class FeatureSubscriber {
    ...
    public static void registerBlocks(@Nonnull RegistryEvent.Register<Feature<?>> event) {
        ...
        registry.register(new AbandonedCampStructure(ProbabilityConfig::deserialize).setRegistryName(Reference.MODID, "abandoned_camp_structure"));
        registry.register(new BurialPlaceStructure(ProbabilityConfig::deserialize).setRegistryName(Reference.MODID, "burial_place_structure"));
