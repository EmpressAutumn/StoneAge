...
public class ToolSubscriber {
    ...
    public static void registerItems(@Nonnull RegistryEvent.Register<Item> event) {
        ...
        registry.register(new AgesPartItem(new Item.Properties().group(ModItemGroup.AGES).maxStackSize(64), boneTierProperties).setRegistryName(Reference.MODID, "bone_axe_head"));
        registry.register(new AgesPartItem(new Item.Properties().group(ModItemGroup.AGES).maxStackSize(64), boneTierProperties).setRegistryName(Reference.MODID, "bone_pickaxe_head"));
        registry.register(new AgesPartItem(new Item.Properties().group(ModItemGroup.AGES).maxStackSize(64), boneTierProperties).setRegistryName(Reference.MODID, "bone_hoe_head"));
        registry.register(new AgesPartItem(new Item.Properties().group(ModItemGroup.AGES).maxStackSize(64), boneTierProperties).setRegistryName(Reference.MODID, "bone_shovel_head"));
        registry.register(new AgesPartItem(new Item.Properties().group(ModItemGroup.AGES).maxStackSize(64), boneTierProperties).setRegistryName(Reference.MODID, "bone_sword_head"));

        registry.register(new AgesPartItem(new Item.Properties().group(ModItemGroup.AGES).maxStackSize(64), stoneTierProperties).setRegistryName(Reference.MODID, "stone_axe_head"));
        registry.register(new AgesPartItem(new Item.Properties().group(ModItemGroup.AGES).maxStackSize(64), stoneTierProperties).setRegistryName(Reference.MODID, "stone_pickaxe_head"));
        registry.register(new AgesPartItem(new Item.Properties().group(ModItemGroup.AGES).maxStackSize(64), stoneTierProperties).setRegistryName(Reference.MODID, "stone_hoe_head"));
        registry.register(new AgesPartItem(new Item.Properties().group(ModItemGroup.AGES).maxStackSize(64), stoneTierProperties).setRegistryName(Reference.MODID, "stone_shovel_head"));
        registry.register(new AgesPartItem(new Item.Properties().group(ModItemGroup.AGES).maxStackSize(64), stoneTierProperties).setRegistryName(Reference.MODID, "stone_sword_head"));
    }
}
